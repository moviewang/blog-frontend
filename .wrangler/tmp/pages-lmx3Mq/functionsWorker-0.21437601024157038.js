...
var posts = [
  {
    ...
    published_at: /* @__PURE__ */ new Date("2020-10-23")
  },
  {
    id: 2,
    title: "Updating my blog",
    text: "It's my second blog post! I'm still writing and publishing using Cloudflare Workers + Pages :)",
    published_at: /* @__PURE__ */ new Date("2020-10-26")
  }
];
var data_default = posts;
...
function onRequestGet(context) {
  ...
  const post = data_default.find((post2) => post2.id === Number(id));
  if (!post) {
    return new Response("Not found", { status: 404 });
  }
...
function onRequestGet2() {
  return Response.json(data_default);
}
...
// ../.wrangler/tmp/pages-lmx3Mq/functionsRoutes-0.2152050233403604.mjs
var routes = [
  {
